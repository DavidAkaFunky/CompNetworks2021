...
#define REG_USER_ERR "There was an error in the registration. Please try again!"
#define UNR_USER_SUC "User successfully unregistered"
#define UNR_USER_FAIL "Unregister request unsuccessful"
#define UNR_USER_ERR "There was an error in the unregistration. Please try again!"
...
#define LOGOUT_ERR "There was an error logging out. Please try again!"
...
#define REG_GRP_ERR2  "There was an error subscribing. Please try again!"
...
#define UNR_GRP_ERR2 "There was an error unsubscribing. Please try again!"
